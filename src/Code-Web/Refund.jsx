...
function Refund(){
    ...
    <div className="Refund">
        ...
        <h2>Refund Policy</h2>
        <p>At CodesWear.com, our primary focus is customer satisfaction, which is why we strive to provide the best products and services. Please note that product images on our website are for representational purposes only<br/> and may vary slightly due to lighting conditions or other factors.</p>
        ...
        <li>In rare cases where return pickup is not available with our courier partner, the customer is responsible for sending the product back to us for refund or replacement processing.
</li>
        <h2>Cancellation Policy</h2>
        <p>To cancel your order, please contact us using the provided contact link. Orders can be canceled until they are shipped from our warehouse. Requests received more than 7 business days prior to the product delivery<br/> date will not be processed.</p>
